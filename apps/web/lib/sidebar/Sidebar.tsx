...
export function Sidebar({
  ...
  const { projects, orphans, loading, hide } = useProjects(5000);
  ...
  return (
    ...
    >
      <div className="flex items-start gap-2">
        ...
        <PopoverMenu
          label={t("sidebar.project.menu")}
          trigger={<EllipsisIcon />}
          side="bottom"
          align="end"
          triggerClassName="shrink-0 mt-0.5 p-1 rounded text-[var(--color-fg-subtle)] hover:text-[var(--color-fg)] hover:bg-[var(--color-bg-elevated)]"
          items={[
            {
              id: "new-session",
              label: t("sidebar.project.contextMenu.createSession"),
              icon: <PlusIcon />,
              onSelect: onStartSession,
            },
            {
              id: "open-files",
              label: t("sidebar.project.contextMenu.openFiles"),
              icon: <FolderIcon />,
              onSelect: onSelect,
            },
            {
              id: "copy-path",
              label: t("sidebar.project.contextMenu.copyPath"),
              icon: <CopyIcon />,
              onSelect: onCopyPath,
            },
            {
              id: "hide",
              label: t("sidebar.project.contextMenu.hide"),
              icon: <EyeOffIcon />,
              destructive: true,
              onSelect: onHide,
            },
        ...
        {sessions.length === 0 ? (
          ...
          sessions.map((s) => (
            ...
            >
              ...
              <PopoverMenu
                label={t("sidebar.session.menu")}
                trigger={<EllipsisIcon />}
                side="bottom"
                align="end"
                minWidth={180}
                triggerClassName="shrink-0 p-0.5 rounded text-[var(--color-fg-subtle)] hover:text-[var(--color-fg)] hover:bg-[var(--color-bg-elevated)]"
                items={[
                  {
                    id: "open",
                    label: t("sidebar.session.contextMenu.open"),
                    icon: <FolderIcon />,
                    onSelect: () => {
                      window.location.href = lp(`/agent/${s.id}`);
                    },
                  },
                  {
                    id: "copy-id",
                    label: t("sidebar.session.contextMenu.copyId"),
                    icon: <CopyIcon />,
                    onSelect: () => {
                  ...
                  {
                    id: "delete",
                    label: t("sidebar.session.row.delete"),
                    icon: <TrashIcon />,
                    destructive: true,
